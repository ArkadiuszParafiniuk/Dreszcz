package giantscastle.dreszcz.application.web.rest;

import giantscastle.dreszcz.application.config.Constants;
import giantscastle.dreszcz.application.DreszczApp;
import giantscastle.dreszcz.application.domain.Authority;
import giantscastle.dreszcz.application.domain.PersistentToken;
import giantscastle.dreszcz.application.domain.User;
import giantscastle.dreszcz.application.repository.AuthorityRepository;
import giantscastle.dreszcz.application.repository.PersistentTokenRepository;
import giantscastle.dreszcz.application.repository.UserRepository;
import giantscastle.dreszcz.application.security.AuthoritiesConstants;
import giantscastle.dreszcz.application.service.MailService;
import giantscastle.dreszcz.application.service.dto.UserDTO;
import giantscastle.dreszcz.application.web.rest.errors.ExceptionTranslator;
import giantscastle.dreszcz.application.web.rest.vm.KeyAndPasswordVM;
import giantscastle.dreszcz.application.web.rest.vm.ManagedUserVM;
import giantscastle.dreszcz.application.service.UserService;
...
@SpringBootTest(classes = DreszczApp.class)
